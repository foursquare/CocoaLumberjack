...
#define DD_LOG_ERROR    (LOG_LEVEL_DEF & LOG_FLAG_ERROR)
#define DD_LOG_WARN     (LOG_LEVEL_DEF & LOG_FLAG_WARN)
#define DD_LOG_INFO     (LOG_LEVEL_DEF & LOG_FLAG_INFO)
#define DD_LOG_DEBUG    (LOG_LEVEL_DEF & LOG_FLAG_DEBUG)
#define DD_LOG_VERBOSE  (LOG_LEVEL_DEF & LOG_FLAG_VERBOSE)
